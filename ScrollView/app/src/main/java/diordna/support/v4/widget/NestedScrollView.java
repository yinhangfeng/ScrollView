...
package diordna.support.v4.widget;
...
//                Log.i(TAG, "onTouchEvent: ACTION_DOWN getChildCount() > 0");
            ...
            case MotionEvent.ACTION_UP:
                ...
                if ((Math.abs(initialVelocity) > mMinimumVelocity)) {
                        ...
                        // 速度需要取反 因为Scroller中正的速度使数值增大 但手势方向与scroll值是相反的
    ...
    public void fling(int velocityY) {
        if (getChildCount() > 0) {
            ...
            */
            ...
            // XXX 修改 minY maxY overY
            // 如果 minY maxY 为 Integer.MIN_VALUE, Integer.MAX_VALUE 则nested fling 可较好的工作单失去了overscroll 回弹功能
            // 所以考虑到nested scroll OverScroller的fling 应该重新设计 在到边缘时需要重新判断
