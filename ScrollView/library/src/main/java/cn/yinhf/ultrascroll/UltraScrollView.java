...
/**
 * UltraScrollView is just like {@link ScrollView}, but it supports acting
 * as both a nested scrolling parent and child on both new and old versions of Android.
 * Nested scrolling is enabled by default.
 */
public class UltraScrollView extends FrameLayout implements NestedScrollingParent,
        NestedScrollingChild, ScrollingView {
    static final int ANIMATED_SCROLL_GAP = 250;

    static final float MAX_SCROLL_FACTOR = 0.5f;

    private static final String TAG = "UltraScrollView";
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(UltraScrollView v, int scrollX, int scrollY,
    ...
    public UltraScrollView(Context context) {
        this(context, null);
    }

    public UltraScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UltraScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            }
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final UltraScrollView nsvHost = (UltraScrollView) host;
